...
import { ArrowRight, CheckCircle2, ChevronRight, Sparkles, Factory, Cog, ShieldCheck, Box, Zap, Search, ShieldAlert, Cpu } from 'lucide-react';
  ...
  const supportCategories = [
    {
      ...
      description: "Training computer vision models to detect surface defects, assembly errors, and structural anomalies in real-time across production lines.",
      features: [
    ...
    },
    {
      ...
      description: "Annotating sensor data and thermal imagery to predict equipment failure before it happens, reducing downtime and maintenance costs.",
      features: [
    ...
    },
    {
      ...
      description: "Ensuring industrial safety by annotating video feeds for PPE compliance (helmets, vests) and detecting hazardous worker behavior or restricted zone entry.",
      features: [
    ...
    },
    {
      ...
      description: "Supporting smart warehouses with annotated data for SKU recognition, autonomous forklift navigation, and package sorting automation.",
      features: [
    ...
    },
    {
      ...
      description: "Preparing datasets for industrial robots to perform complex tasks like pick-and-place, precision welding, and collaborative human-robot interaction.",
      features: [
    ...
    <div className="bg-white text-slate-900 min-h-screen pb-8 font-sans selection:bg-brand-100 selection:text-brand-900">
      ...
      <div className="relative bg-white overflow-hidden pt-24 pb-16">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 flex flex-col items-center text-center">
          <div className="flex items-center gap-2 text-slate-400 text-[11px] font-bold uppercase tracking-[0.2em] mb-8">
            ...
            <ChevronRight size={10} strokeWidth={3} />
            <span className="text-brand-600">Manufacturing & Industry 4.0</span>
          </div>
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-slate-900 tracking-tight leading-[1.1] mb-6 max-w-4xl">
            Manufacturing & Industrial Automation Data Annotation
          </h1>
          
          <p className="text-base md:text-lg text-slate-600 font-medium leading-relaxed mb-10 max-w-4xl">
            Optimize production quality, ensure worker safety, and enable autonomous logistics. We provide high-fidelity datasets that power the next generation of Industry 4.0 technologies.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link to="/contact">
              <button className="flex items-center gap-3 bg-slate-900 text-white px-10 py-3.5 rounded-full font-semibold text-base hover:bg-brand-600 transition-all hover:shadow-xl hover:shadow-brand-600/20 active:scale-95">
                <ArrowRight size={18} /> Request Industrial Sample
              </button>
            </Link>
          </div>
        </div>
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-slate-200/50 border border-slate-100">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-brand-600 text-[11px] font-semibold uppercase tracking-[0.3em]">Operational Excellence</span>
              </div>
              ...
              <p className="text-slate-600 text-lg md:text-xl font-medium leading-relaxed mb-12">
                Industry 4.0 relies on accurate perception and predictive intelligence. As a leading data partner in India, we support global manufacturers and industrial AI startups with high-precision annotation for quality inspection, safety monitoring, and autonomous logistics.
                <br /><br />
                From detailed defect segmentation to real-time safety auditing, our specialized industrial annotation services ensure your models can operate reliably in complex factory environments.
              </p>
      ...
      <div className="mt-24 space-y-0">
        <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
           ...
           <p className="text-slate-500 font-medium max-w-2xl mx-auto">Scalable ground truth datasets tailored for automated factories, smart warehouses, and industrial safety platforms.</p>
        </div>
            ...
            <div className={`max-w-7xl mx-auto px-6 flex flex-col ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} gap-12 md:gap-24 items-center`}>
              ...
              <div className="flex-1 w-full max-w-lg">
                <div className="aspect-[16/9] bg-slate-950 rounded-[2.5rem] p-10 flex flex-col justify-center relative overflow-hidden shadow-sm border border-slate-800 group">
                    <div className="text-brand-600 font-mono text-[10px] tracking-widest uppercase mb-4">Industrial_QA_Data_Sample</div>
                    <div className="space-y-3 font-mono text-xs md:text-sm">
                        <div className="text-white"><span className="text-brand-400">"audit_type"</span>: <span className="text-green-400">"{service.title.split(' ')[0]}...inspect"</span></div>
                        <div className="text-white"><span className="text-brand-400">"status"</span>: {"{"}</div>
                        <div className="pl-4 text-white"><span className="text-brand-400">"result"</span>: <span className="text-accent-cyan">"Compliant"</span></div>
                        <div className="pl-4 text-white"><span className="text-brand-400">"confidence"</span>: <span className="text-accent-cyan">0.9995</span></div>
      ...
      <div className="py-24 bg-slate-950 text-white overflow-hidden relative">
         ...
         <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
            <h2 className="text-3xl md:text-5xl font-semibold mb-8 tracking-tight">Optimize your production</h2>
            <p className="text-slate-400 text-lg mb-12 max-w-2xl mx-auto font-medium">
               Join global manufacturers who trust LabelzAI for high-accuracy visual inspection and safety auditing datasets.
            </p>
            <Link to="/contact">
