...
import { ArrowRight, CheckCircle2, ChevronRight, Sparkles, Car, Cpu, Zap, Microscope, Cog, Search, Map, Truck, Navigation2 } from 'lucide-react';
  ...
  const supportCategories = [
    {
      ...
      description: "Detailed annotation for camera, LiDAR, and multi-sensor datasets. We help improve object detection, path planning, and collision avoidance for complex urban scenarios.",
      features: [
        "Camera & LiDAR Fusion",
        "3D Bounding Boxes",
    ...
    },
    {
      ...
      description: "Supporting features like lane departure warning, adaptive cruise control, and blind-spot detection through high-quality 2D/3D labeling and object tracking.",
      features: [
    ...
    },
    {
      ...
      description: "Labeling real-world driving events, traffic density, and road conditions to enhance fleet intelligence, route optimization, and safety monitoring.",
      features: [
    ...
    },
    {
      ...
      description: "Assisting urban mobility initiatives by annotating traffic flow, pedestrian movement, congestion patterns, and incident scenarios for AI-driven optimization.",
      features: [
    ...
    },
    {
      ...
      description: "Environmental understanding for delivery robots and warehouse mobility. Support for obstacle detection and path navigation across indoor/outdoor environments.",
      features: [
    ...
    <div className="bg-white text-slate-900 min-h-screen pb-8 font-sans selection:bg-brand-100 selection:text-brand-900">
      ...
      <div className="relative bg-white overflow-hidden pt-24 pb-16">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 flex flex-col items-center text-center">
          <div className="flex items-center gap-2 text-slate-400 text-[11px] font-bold uppercase tracking-[0.2em] mb-8">
            ...
            <ChevronRight size={10} strokeWidth={3} />
            <span className="text-brand-600">Autonomous Vehicles & Mobility</span>
          </div>
          ...
          <p className="text-base md:text-lg text-slate-600 font-medium leading-relaxed mb-10 max-w-4xl">
            The Autonomous Vehicles & Mobility sector is transforming transportation through AI-powered perception, real-time decision-making, and intelligent infrastructure. We deliver high-precision labeling services that enable automotive companies to train reliable AI systems.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link to="/contact">
              <button className="flex items-center gap-3 bg-slate-900 text-white px-10 py-3.5 rounded-full font-semibold text-base hover:bg-brand-600 transition-all hover:shadow-xl hover:shadow-brand-600/20 active:scale-95">
                <ArrowRight size={18} /> Request Data Sample
              </button>
            </Link>
          </div>
        </div>
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-slate-200/50 border border-slate-100">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-brand-600 text-[11px] font-semibold uppercase tracking-[0.3em]">Scalable Perception</span>
              </div>
              ...
              <p className="text-slate-600 text-lg md:text-xl font-medium leading-relaxed mb-12">
                As a data annotation startup in India, we support this industry by delivering high-precision labeling services that enable automotive and mobility companies to train reliable, safety-critical AI systems across diverse real-world environments.
                <br /><br />
                From detailed camera-LiDAR fusion to behavior classification, we provide the ground truth data needed for vehicles to navigate safely and cities to manage traffic intelligently.
              </p>
      ...
      <div className="mt-24 space-y-0">
        <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
           ...
           <p className="text-slate-500 font-medium max-w-2xl mx-auto">Scalable ground truth datasets tailored for automotive OEMs, ADAS providers, and smart infrastructure.</p>
        </div>
            ...
            <div className={`max-w-7xl mx-auto px-6 flex flex-col ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} gap-12 md:gap-24 items-center`}>
              ...
              <div className="flex-1 w-full max-w-lg">
                <div className="aspect-[16/9] bg-slate-950 rounded-[2.5rem] p-10 flex flex-col justify-center relative overflow-hidden shadow-sm border border-slate-800 group">
                    <div className="text-brand-600 font-mono text-[10px] tracking-widest uppercase mb-4">AV_Perception_Data_Sample</div>
                    <div className="space-y-3 font-mono text-xs md:text-sm">
                        <div className="text-white"><span className="text-brand-400">"sensor"</span>: <span className="text-green-400">"{service.title.split(' ')[0]}...liDAR"</span></div>
                        <div className="text-white"><span className="text-brand-400">"object_idx"</span>: {"{"}</div>
                        <div className="pl-4 text-white"><span className="text-brand-400">"class"</span>: <span className="text-accent-cyan">"Vehicle"</span></div>
                        <div className="pl-4 text-white"><span className="text-brand-400">"confidence"</span>: <span className="text-accent-cyan">0.9997</span></div>
      ...
      <div className="py-24 bg-slate-950 text-white overflow-hidden relative">
         ...
         <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
            <h2 className="text-3xl md:text-5xl font-semibold mb-8 tracking-tight">Ready to fuel your AV models?</h2>
            <p className="text-slate-400 text-lg mb-12 max-w-2xl mx-auto font-medium">
               Join global automotive leaders and smart city developers who trust LabelzAI for precision-driven mobility datasets.
            </p>
            <Link to="/contact">
